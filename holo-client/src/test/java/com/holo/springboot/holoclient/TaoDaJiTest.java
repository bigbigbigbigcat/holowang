...
//                    System.out.println("=========================");
                    ...
                    if (CollectionUtils.isNotEmpty(taoDaJiResp.getData().getItems())) {
                        ...
                        for (int i = 0; i < items.size(); i++) {
                            ...
                            String storeName = dataItem.getStoreName();
                            String monthSaleNumbers = dataItem.getMonthSaleNumbers();
...
//                System.out.println(String.format("商品名称：%s,价格：%s元/%s(%s%s)",name,price,level1Unit,level2Value,level2Unit));
                            ...
                            returnMap.put("monthSaleNumbers", monthSaleNumbers);
...
//                                System.out.println(String.format("商品名称：%s,规格：一%s",name,level1Unit));
                            ...
                            } else if (StringUtils.isNotBlank(level2Unit)) {
                        ...
                        for (String key : returnListMap.keySet()) {
                            if (m1.get(key) == null) {
                                ...
                                for (Map<String, String> mapList : value) {
                                    ...
                                    System.out.println(String.format("%s,%s,%s", mapList.get("name"), mapList.get("unit"), mapList.get("storeName")));
                                    map.put(0, mapList.get("name"));
                                    map.put(1, mapList.get("unit"));
                                    map.put(2, mapList.get("storeName"));
                                    map.put(3, mapList.get("monthSaleNumbers"));
                                    l1.add(map);
                                }
                                m1.put(key, l1);
                            } else {
